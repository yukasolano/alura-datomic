...
(println "Instante da venda")
(pprint (db.venda/instante-da-venda (d/db conn) venda1))

(println "Custo da venda1 e da venda2 com preço no instante das vendas")
(pprint (db.venda/custo-no-instante-da-venda (d/db conn) venda1))
(pprint (db.venda/custo-no-instante-da-venda (d/db conn) venda2))
